...
public class MarkersController
    ...
    private void add(Object markerObj) {
        if (null != amap) {
            ...
            String dartMarkerId = MarkerUtil.interpretMarkerOptions(markerObj, builder,mContext);
    ...
    private void update(Object markerToChange) {
        ...
        if (null != dartMarkerId) {
            ...
            if (null != markerController) {
                MarkerUtil.interpretMarkerOptions(markerToChange, markerController,mContext);
            }
        }
    }
